...
<body>
	...
	<div class="container">
		...
		<form method="post"
			action="<c:out value="${pageContext.servletContext.contextPath}"/>/nouveau">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="number" class="form-control" id="mise_prix"
						name="mise_prix" value="150" value="${article.prixInitial}" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="date" class="form-control" id="date_debut"
						name="date_debut" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${now}"/>" required>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col">
					...
					<a class="btn btn-warning" href="<c:out value="${pageContext.servletContext.contextPath}" />">Annuler</a>
				</div>
			</div>
